...
customElements.define("action-handler-media-player-tile", ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector("action-handler-media-player-tile")) {
    return body.querySelector(
      "action-handler-media-player-tile",
    ) as ActionHandler;
  }
